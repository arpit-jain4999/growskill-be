...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Updates the authenticated user’s profile. Only provided fields are updated (firstName, lastName, email, profilePicture, bio). Phone/countryCode are not editable here. Response: `{ success: true, data: UserProfileResponseDto }`.',
    }),
    (0, swagger_1.ApiOkResponse)({
    ...
    (0, swagger_1.ApiBadRequestResponse)({ description: 'Validation error (e.g. invalid email)', type: error_response_dto_1.StandardErrorResponseDto }),
    (0, swagger_1.ApiNotFoundResponse)({ description: 'User not found', type: error_response_dto_1.StandardErrorResponseDto }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid JWT', type: error_response_dto_1.StandardErrorResponseDto }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
exports.UsersController = UsersController = __decorate([
    ...
    (0, swagger_1.ApiExtraModels)(user_profile_response_dto_1.UserProfileResponseDto, update_user_dto_1.UpdateUserDto, error_response_dto_1.StandardErrorResponseDto),
