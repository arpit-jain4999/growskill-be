...
export class ChaptersController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all active chapters', description: 'Any authenticated user in the org can read.' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get chapter by ID', description: 'Any authenticated user in the org can read.' })
  ...
  @Get('module/:moduleId')
  @ApiOperation({ summary: 'Get chapters by module ID', description: 'Returns all active chapters for a module, sorted by order. Any authenticated user in the org can read.' })
